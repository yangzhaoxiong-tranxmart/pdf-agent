...
def get_checkpoint(
    ...
    '''
    ptext = text.replace('O', '{c1}').replace('@', '{c2}').replace('.', '{c3}').replace('\\', '{c4}').replace('`', '{c5}').replace('/', '{c6}').replace(',', '{c7}')
    pptext = ptext.format(c1='\033[38;5;66mO\033[0m',
                          c2='\033[38;5;21mO\033[0m',
                          c3='\033[38;5;236m*\033[0m',
                          c4='\033[38;5;22mO\033[0m',
                          c5='\033[38;5;23mo\033[0m',
                          c6='\033[38;5;56mO\033[0m',
                          c7='\033[38;5;54mo\033[0m')
    print(pptext)
    checkpoint = Path(
